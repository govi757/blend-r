...
import { BlendApiVisitor } from "./BlendApiVisitor";
...
export class ProgramContext extends ParserRuleContext {
	...
	// @Override
	public accept<Result>(visitor: BlendApiVisitor<Result>): Result {
...
export class SectionDefinitionContext extends ParserRuleContext {
	...
	// @Override
	public accept<Result>(visitor: BlendApiVisitor<Result>): Result {
		if (visitor.visitSectionDefinition) {
...
export class ApiDefinitionContext extends ParserRuleContext {
	...
	public accept<Result>(visitor: BlendApiVisitor<Result>): Result {
		if (visitor.visitApiDefinition) {
			return visitor.visitApiDefinition(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
...
export class AuthenticatedContext extends ParserRuleContext {
	...
	// @Override
	public accept<Result>(visitor: BlendApiVisitor<Result>): Result {
		if (visitor.visitAuthenticated) {
			return visitor.visitAuthenticated(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
...
export class InputDefinitionContext extends ParserRuleContext {
	...
	// @Override
	public accept<Result>(visitor: BlendApiVisitor<Result>): Result {
		if (visitor.visitInputDefinition) {
			return visitor.visitInputDefinition(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
...
export class OutputDefinitionContext extends ParserRuleContext {
	...
	// @Override
	public accept<Result>(visitor: BlendApiVisitor<Result>): Result {
		if (visitor.visitOutputDefinition) {
			return visitor.visitOutputDefinition(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
...
export class DirectOutputDefenitionContext extends ParserRuleContext {
	...
	// @Override
	public accept<Result>(visitor: BlendApiVisitor<Result>): Result {
		if (visitor.visitDirectOutputDefenition) {
			return visitor.visitDirectOutputDefenition(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
